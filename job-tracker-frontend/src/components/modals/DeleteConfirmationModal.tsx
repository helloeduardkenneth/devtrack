...
export const DeleteConfirmationModal = ({
    ...
    const shouldShowModal = isOpen && (isBulkDelete || !!application)
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            background:
                                'linear-gradient(90deg, #fca5a5, #ef4444 40%, #dc2626)',
                        }}
                    />
                    ...
                    <div className="px-6 pt-7 pb-6">
                        ...
                        >
                            ...
                            <p className="mt-1 text-sm leading-relaxed text-slate-500">
                                ...
                                {isBulkDelete
                                    ? `The selected ${selectedCount} applications will be permanently removed.`
                                    : 'The following record will be removed.'}
                            </p>
                        </motion.div>

                        {/* Application details card - only show for single delete */}
                        {!isBulkDelete && application && (
                            <motion.div
                                initial={{ opacity: 0, y: 6 }}
                                animate={{ opacity: 1, y: 0 }}
                        ...
                        {isBulkDelete && (
                            ...
                            >
                                <p className="text-sm text-amber-800">
                                    ...
                                    delete {selectedCount} applications. This
