...
export const ViewApplicationModal = ({
  ...
  const statusKey = formatStatus(application.status) as keyof typeof STATUS_COLORS
  const statusClass = STATUS_COLORS[statusKey] || 'bg-slate-100 text-slate-700 border-slate-200'
                ...
                <div className="flex flex-1 flex-col justify-center min-w-0 py-1">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 px-3 py-1.5 text-sm font-medium text-slate-700">
                      ...
                      {formatPriority(application.priority)} Priority
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="px-6 pb-8 space-y-6">
              ...
              >
                {application.location && (
                  <div className="flex items-center gap-3 rounded-xl bg-slate-50 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-slate-900">{application.location}</p>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-center gap-3 rounded-xl bg-slate-50 p-4">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Job Type</p>
                    <p className="text-sm font-semibold text-slate-900">{formatJobType(application.job_type)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 rounded-xl bg-slate-50 p-4">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Work Mode</p>
                    <p className="text-sm font-semibold text-slate-900">{formatWorkMode(application.work_mode)}</p>
                  </div>
                </div>
              ...
              >
                <h3 className="mb-4 flex items-center gap-2 text-sm font-bold text-slate-900 uppercase tracking-wide">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm font-semibold text-slate-900">{formatDate(application.applied_date)}</p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-slate-500">Priority</p>
                    <p className="mt-1 text-sm font-semibold text-slate-900">{formatPriority(application.priority)}</p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-slate-500">Source</p>
                    <p className="mt-1 text-sm font-semibold text-slate-900">{formatSource(application.source)}</p>
                  </div>
                </div>
              </motion.div>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium text-slate-500">Job Posting</p>
                        <p className="text-sm font-medium text-blue-600 group-hover:underline truncate max-w-[300px]">
                          {application.job_url}
                        </p>
                      </div>
                    </div>
              ...
              {application.job_description && (
                <motion.div
                  ...
                  className="rounded-xl border border-slate-200 bg-white p-5"
                >
                  <h3 className="mb-3 flex items-center gap-2 text-sm font-bold text-slate-900 uppercase tracking-wide">
              ...
              {application.notes && (
                ...
                >
                  <h3 className="mb-3 flex items-center gap-2 text-sm font-bold text-amber-800 uppercase tracking-wide">
                    ...
                    {application.recruiter_name && (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-slate-900">{application.recruiter_name}</p>
                        </div>
                      </div>
                    )}
                    {application.recruiter_email && (
                    ...
                    {application.recruiter_phone && (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-slate-900">{application.recruiter_phone}</p>
                        </div>
                      </div>
                    )}
                  </div>
