                  ...
                  <div className="grid grid-cols-2 gap-6">
                          ...
                          <div className="flex items-center gap-3 px-4">
                            ...
                            <div className="min-w-0 flex-1">
                              <p className="truncate text-xs font-medium text-slate-700">
                                {logoFile?.name ||
                                  form.getValues('companyLogoFilename') ||
                                  'Logo loaded'}
                              </p>
                            </div>
                            <Button
                    ...
                    <div className="col-span-2 md:col-span-1">
                      ...
                      <Select
                        value={jobType}
                        onValueChange={(value) =>
                          setValue('jobType', value as AddJobFormValues['jobType'], {
                            shouldValidate: true,
                          })
                        }
                      >
                    ...
                    <div className="col-span-2 md:col-span-1">
                      ...
                      <Select
                        value={workMode}
                        onValueChange={(value) =>
                          setValue('workMode', value as AddJobFormValues['workMode'], {
                            shouldValidate: true,
                          })
                        }
                      >
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <Select
                        value={status}
                        onValueChange={(value) =>
                          setValue('status', value as AddJobFormValues['status'], {
                            shouldValidate: true,
                          })
                        }
                      >
                    ...
                    <div>
                      ...
                      <Select
                        value={priority}
                        onValueChange={(value) =>
                          setValue('priority', value as AddJobFormValues['priority'], {
                            shouldValidate: true,
                          })
                        }
                      >
                    ...
                    <div>
                      ...
                      <Select
                        value={source}
                        onValueChange={(value) =>
                          setValue('source', value as AddJobFormValues['source'], {
                            shouldValidate: true,
                          })
                        }
                      >
