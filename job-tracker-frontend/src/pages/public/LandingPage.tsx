...
const Hero = ({ onGetStarted }: { onGetStarted: () => void }) => (
  <section className="relative overflow-hidden bg-linear-to-b from-blue-50/30 via-white to-white px-6 pt-32 pb-20">
    ...
    <div className="mx-auto max-w-5xl space-y-8 text-center">
      ...
      >
        The modern job application tracker built for developers. Organize, analyze, and
        optimize your job search with AI-powered insights.
      </motion.p>
    ...
    >
          ...
          <div className="grid grid-cols-4 gap-3 pt-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="space-y-2">
                ...
                {[1, 2].map((j) => (
                  <div key={j} className="space-y-2 rounded-lg bg-slate-800 p-3">
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">Google • Tomorrow 2PM</p>
        </div>
      </motion.div>
      ...
      >
        <p className="mb-2 text-xs font-semibold text-slate-500">This Week</p>
        ...
        <p className="mt-2 text-xs font-bold text-slate-900">+23% Response Rate</p>
      </motion.div>
    </motion.div>
  </section>
)
  ...
  <section className="border-y border-slate-100 bg-white py-12">
    <div className="mx-auto max-w-7xl px-6">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 opacity-40">
        ...
        <span className="text-xl font-bold text-slate-900">Microsoft</span>
        <span className="text-xl font-bold text-slate-900">Netflix</span>
    ...
    <div className="mx-auto max-w-7xl space-y-12">
      <div className="mx-auto max-w-3xl space-y-4 text-center">
        ...
        <p className="text-lg text-slate-600">
          All the tools to organize, track, and optimize your developer job search in one
          place.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-900 to-slate-800 p-8 md:col-span-2 md:p-12">
          ...
          <div className="relative z-10 space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1">
              ...
              <span className="text-xs font-semibold text-blue-400">Visual Pipeline</span>
            </div>
            <h3 className="text-3xl font-semibold text-white">
              Drag & Drop Kanban Board
            </h3>
            <p className="max-w-lg text-lg leading-relaxed text-slate-400">
              Move applications through your pipeline with a beautiful Kanban interface.
              Visual tracking that actually feels good to use.
            </p>
            ...
            <div className="grid grid-cols-3 gap-3 pt-6">
              {['Applied', 'Interview', 'Offer'].map((col) => (
                <div key={col} className="space-y-2">
                  <div className="mb-3 text-xs font-semibold text-slate-500">{col}</div>
                  {[1, 2].map((j) => (
                    <div
                      key={j}
                    ...
                    >
                      ...
                      <div className="flex gap-1 pt-1">
                        {[1, 2, 3].map((k) => (
                          <div key={k} className="h-1 w-6 rounded bg-slate-700"></div>
                        ))}
                      </div>
                    </div>
                  ))}
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-blue-500 to-indigo-600 p-8">
          ...
          <div className="relative z-10 flex h-full flex-col space-y-6">
            ...
            <h3 className="text-2xl font-semibold text-white">Real-Time Insights</h3>
            <p className="leading-relaxed text-blue-100">
              Track response rates, time-to-offer, and optimize your strategy with data.
            </p>

            {/* Mock stats */}
            <div className="mt-auto space-y-3">
              <div className="rounded-xl bg-white/10 p-4 backdrop-blur">
                <p className="mb-1 text-xs text-blue-100">Response Rate</p>
                <p className="text-3xl font-semibold text-white">34%</p>
              </div>
              <div className="rounded-xl bg-white/10 p-4 backdrop-blur">
                <p className="mb-1 text-xs text-blue-100">Avg. Time to Offer</p>
                <p className="text-3xl font-semibold text-white">21d</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-purple-100 bg-linear-to-br from-purple-50 to-pink-50 p-8">
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-semibold text-slate-900">Smart Job Parser</h3>
            <p className="leading-relaxed text-slate-600">
              Paste any job posting and AI extracts company, role, salary, and
            ...
            <div className="space-y-2 rounded-xl border border-purple-200 bg-white p-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-slate-500">Parsing...</span>
              </div>
        ...
        <div className="rounded-3xl border border-amber-100 bg-linear-to-br from-amber-50 to-orange-50 p-8">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-amber-100 px-3 py-1">
              ...
              <span className="text-xs font-semibold text-amber-600">Reminders</span>
            </div>
            <h3 className="text-2xl font-semibold text-slate-900">
              Never Miss a Follow-up
            </h3>
            <p className="leading-relaxed text-slate-600">
              Automatic reminders keep you on top of every application, interview, and
              deadline.
            </p>
        ...
        <div className="rounded-3xl border border-green-100 bg-linear-to-br from-green-50 to-emerald-50 p-8">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-green-100 px-3 py-1">
              ...
              <span className="text-xs font-semibold text-green-600">Activity</span>
            </div>
            <h3 className="text-2xl font-semibold text-slate-900">Complete History</h3>
            <p className="leading-relaxed text-slate-600">
              Every action tracked. See exactly what happened and when for each
              application.
            </p>

            <div className="space-y-3 pt-2">
              {[
                { icon: FileText, label: 'Application sent', color: 'blue' },
                { icon: Users, label: 'Recruiter call', color: 'purple' },
                { icon: Target, label: 'Interview scheduled', color: 'green' },
              ].map((item, i) => (
    ...
    <div className="relative z-10 mx-auto max-w-7xl">
      <div className="mx-auto mb-16 max-w-3xl space-y-4 text-center">
        ...
        <p className="text-lg text-slate-400">
          Experience the job tracking tool that actually understands your workflow.
        </p>
      </div>
          ...
          <div className="rounded-2xl border border-slate-700 bg-slate-800 p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="space-y-2 rounded-xl bg-slate-700/50 p-4">
  ...
  <section id="testimonials" className="bg-white px-6 py-24">
    <div className="mx-auto max-w-7xl">
      <div className="mx-auto mb-16 max-w-3xl space-y-4 text-center">
        ...
        <p className="text-lg text-slate-600">
          Join 10,000+ engineers who landed their dream jobs with DevTrack.
        </p>
      </div>
        ...
        {[
          {
            ...
            quote:
              'DevTrack helped me track 47 applications and land 3 offers. The analytics showed me exactly where to improve.',
            rating: 5,
          },
          {
            name: 'Marcus Johnson',
            ...
            quote:
              'Finally ditched my messy spreadsheet. The Kanban board and reminders are game changers.',
            rating: 5,
          },
          {
            name: 'Priya Patel',
            ...
            quote:
              'The AI job parser saved me hours of data entry. This tool is essential for any serious job search.',
            rating: 5,
          },
        ].map((testimonial, i) => (
          <motion.div
          ...
          <div className="relative z-10 space-y-6">
            <div className="border-b border-slate-100 pb-6 text-center">
              ...
              <div className="mb-3 flex items-baseline justify-center gap-2">
                <span className="text-6xl font-semibold text-slate-900">$0</span>
                <span className="font-semibold text-slate-500">/month</span>
              </div>
              <p className="text-slate-600">Everything you need to land your next role</p>
            </div>
      ...
      <div className="relative space-y-8 overflow-hidden rounded-[48px] bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-12 text-center md:p-20">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="mx-auto max-w-2xl text-xl text-slate-300">
            Join 10,000+ developers already using DevTrack to organize their job search
    ...
    <div className="mx-auto mb-12 grid max-w-7xl grid-cols-2 gap-8 md:grid-cols-4">
      <div className="col-span-2 space-y-4">
        ...
        <p className="max-w-sm text-sm leading-relaxed">
          The modern job application tracker built for developers who want to land their
          dream roles faster.
        </p>
