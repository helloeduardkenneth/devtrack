...
const StatCard = ({
  ...
  >
    ...
    <div className="space-y-1">
      ...
      <p className={`text-4xl font-bold ${isPrimary ? 'text-white' : 'text-slate-900'}`}>
        {value}
      </p>
      {subtitle && (
        <p
...
const ApplicationRow = ({ company, position, status, date, salary, index }: any) => {
  const companyColors = [
...
const InterviewCard = ({ company, role, date, type, index }: any) => {
  const interviewColors = [
    ...
    { bg: 'bg-purple-600', icon: 'bg-purple-50', iconColor: 'text-purple-600' },
  ...
  const applications = [
    {
      ...
      status: { label: 'Interview', color: 'bg-purple-100 text-purple-700' },
      date: '2 days ago',
      salary: '₱120k - ₱180k',
    },
    {
    ...
    },
    {
      ...
      status: { label: 'Phone Screen', color: 'bg-indigo-100 text-indigo-700' },
      date: '5 days ago',
      salary: '₱90k - ₱150k',
    },
    {
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <p className="mb-2 text-4xl font-semibold text-slate-900">5.2 days</p>
