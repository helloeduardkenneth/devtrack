...
const Applications = () => {
    ...
    const handleEditById = (id: string) => {
        const target = applicationsData.find(
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="space-y-2">
                        ...
                        <div className="h-3.5 w-64 animate-pulse rounded-md bg-slate-200" />
                    </div>
                ...
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    {/* Table header */}
                    <div className="grid grid-cols-[2rem_1fr_1fr_1fr_1fr_5rem] items-center gap-0 border-b border-slate-200 px-4 py-3">
                        <div className="h-4 w-4 animate-pulse rounded bg-slate-200" />
                        {['w-20', 'w-16', 'w-14', 'w-16', 'w-10'].map(
                            (w, i) => (
                                <div
                                    key={i}
                    ...
                    {Array.from({ length: 5 }).map((_, i) => (
                        <div
                            key={i}
                            className={`grid grid-cols-[2rem_1fr_1fr_1fr_1fr_5rem] items-center gap-0 px-4 py-3.5 ${
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-16 shadow-sm">
                <div className="mx-auto max-w-md text-center">
                    ...
                    <p className="mb-8 text-slate-600">
                        Track your first job application to get started on your
                        career journey
                    </p>
                    <button
